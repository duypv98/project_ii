                ...
                <Card className="admin-function">
                    <CardBody>
                        ...
                        <Button
                            ...
                            <MDBIcon icon="magic" className="ml-3" />
                        </Button>
                        <Button color="info">
                            Thêm bằng tay
                            <MDBIcon icon="hand-spock-o" className="ml-3" />
                        </Button>
                    </CardBody>
                </Card>
                {this.renderMovie()}
        ...
        if (this.state.editing) {
            return (
                <Card className="admin-movie">
                    <Form initialValues={this.state.movie} onSubmit={this.onSubmit}>
                        {({ formState }) => (
                            <CardBody>
                                <table className="admin-table">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>imdb_rating</td>
                                            <td>
                                                <Text field="imdb_rating"
                                                    className={"admin-form-input" + (formState.errors.imdb_rating ? " error" : "")}
                                                    validate={this.validateRequired} /></td>
                                        </tr>
                                        <tr>
                                            <td>age_rated</td>
                                            <td>
                                                <Text field="age_rated"
                                                    className={"admin-form-input" + (formState.errors.age_rated ? " error" : "")}
                                                    validate={this.validateRequired} /></td>
                                        </tr>
                                        <tr>
                                            <td>image_url</td>
                                        ...
                                        <tr>
                                            <td>trailer_url</td>
                                            <td>
                                                <Text field="trailer_url"
                                                    className={"admin-form-input" + (formState.errors.trailer_url ? " error" : "")}
                                                    validate={this.validateRequired} /></td>
                                        </tr>
                                        <tr>
                                            <td>main_actors</td>
                                            <td>
                                                <Text field="main_actors"
                                                    className={"admin-form-input" + (formState.errors.main_actors ? " error" : "")}
                                                    validate={this.validateRequired} /></td>
                                        </tr>
                                        <tr>
                                            <td>types</td>
                                            <td>
                                                <Text field="types"
                                                    className={"admin-form-input" + (formState.errors.types ? " error" : "")}
                                                    validate={this.validateRequired} /></td>
                                        </tr>
                                        <tr>
                                            <td>description</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <Text field="duration"
                                                    className={"admin-form-input" + (formState.errors.duration ? " error" : "")}
                                                    validate={this.validateRequired} /></td>
                                        </tr>
                                    </tbody>
