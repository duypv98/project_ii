...
import {
    ...
    Collapse, NavItem, NavLink, Dropdown, DropdownToggle, DropdownMenu, DropdownItem
} from 'mdbreact';
    ...
    render() {
        return (
            <Navbar color="warning-color" light expand="md" scrolling>
                <NavbarBrand href="/">
                    <img className="brand-img" src={require('./../../assets/images/React-Logo-Trans.png')} alt=""></img>
                </NavbarBrand>
                <NavLink to="/" className="nav-title">GoPro-MDb</NavLink>
                {!this.state.isWideEnough && <NavbarToggler onClick={this.onClick} />}
                <Collapse isOpen={this.state.collapse} navbar>
                    <NavbarNav left>
                        <NavItem active>
                            <NavLink to="/" className="nav-custom">Home Page</NavLink>
                        </NavItem>
                        <NavItem>
                            <Dropdown>
                                ...
                                <DropdownMenu className="drop-menu-custom">
                                    ...
                                    <DropdownItem href="type/Fiction">Viễn tưởng</DropdownItem>
                                    <DropdownItem href="type/Horror">Kinh dị</DropdownItem>
                                    <DropdownItem href="type/Family">Gia đình</DropdownItem>
                                    <DropdownItem href="type/Comedy">Hài hước</DropdownItem>
                    ...
                    <NavbarNav right>
                        <NavItem>
                            <input className="form-control" type="text" placeholder="Tìm kiếm phim..."
